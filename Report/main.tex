...
\begin{titlepage}
\begin{center}
\includegraphics[width=.10\textwidth]{../Figures/Misc/University_of_Amsterdam_logo.pdf}\\
...
\begin{minipage}[t][8cm][t]{0,4\textwidth}
...
\dedicatory{Dedicated to my\ldots} % Dedication text
