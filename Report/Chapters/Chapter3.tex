...
\caption{\textit{``Unshackling Evolution: Evolving Soft Robots with Multiple
Materials and a Powerful Generative Encoding''} \citep{cheney2013unshackling}.}
...
\caption{Soft robot bodies built out of meshes of tetrahedra \citep{rieffel2014growing}.}
\label{fig:meshSoft}
\end{figure}
