...
\caption{Champion (best overall) morphologies evolved in independent runs within fitness-based search. Each row presents the locomotion strategy of the individuals created.}
...
\caption{}
\end{subfigure}
\caption{Champion morphologies evolved in independent runs within novelty search. Each row presents the locomotion strategy of the individuals created.}
...
\end{subfigure}\\
\caption{Champion morphologies evolved in independent runs within fitness-based and novelty search. Each row presents the locomotion strategy of the individuals created.}
...
\end{subfigure}
\caption{\textbf{Earth}: Morphologies evolved in gravity conditions on Earth, show that life-like locomotion strategies can be generated by soft-body creatures in a simulated environment.}
...
\end{subfigure}
\caption{\textbf{Moon}: Locomotion strategies evolved in low-gravity conditions (Moon) consist mostly of hopper soft-robots.}
...
\end{subfigure}
\caption{\textbf{Mars}: Gravity acceleration on Mars allows both galloping and hopping locomotion strategies.}
...
\caption{C-shaped hopper (Novelty-Search)}
\end{subfigure}
\caption{\textbf{Jupiter}: Heavier structures on Jupiter's gravity level can locomote efficiently using several strategies.}
