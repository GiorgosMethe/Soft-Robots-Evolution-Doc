...
\includegraphics[width=0.05\textwidth]{../Figures/Robots/fit-1-\i.jpg}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.05\textwidth]{../Figures/Robots/fit-2-\i.jpg}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.05\textwidth]{../Figures/Robots/fit-4-\i.jpg}	
}\\
...
\centering
\foreach \i in {1,2,3,4,5,6,7,8}{ 
\includegraphics[width=0.05\textwidth]{../Figures/Robots/nov-1-\i.jpg}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.05\textwidth]{../Figures/Robots/nov-2-\i.jpg}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.05\textwidth]{../Figures/Robots/nov-3-\i.jpg}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.05\textwidth]{../Figures/Robots/nov-4-\i.jpg}
}\\
