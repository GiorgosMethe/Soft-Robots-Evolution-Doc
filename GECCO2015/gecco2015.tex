...
\doi{http://dx.doi.org/10.1145/2739480.XXXXXXXX}
...
\alignauthor
Georgios Methenitis\titlenote{The present work is based on my master's thesis~\cite{methenitis2014evolution}, work conducted under the supervision of both University of Amsterdam and the European Space Agency (ESTEC).}\\
...
%For all recorded behavior metrics a constant sampling rate ensures that all signals have the same length. 
