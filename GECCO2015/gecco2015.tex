...
\includegraphics[width=0.055\textwidth]{../Figures/Robots/fit-1-\i.jpg}\hspace{-0.16cm}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.055\textwidth]{../Figures/Robots/fit-2-\i.jpg}\hspace{-0.16cm}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.055\textwidth]{../Figures/Robots/fit-4-\i.jpg}\hspace{-0.16cm}
}\\
...
\centering
\foreach \i in {1,2,3,4,5,6,7,8}{ 
\includegraphics[width=0.055\textwidth]{../Figures/Robots/nov-1-\i.jpg}\hspace{-0.16cm}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.055\textwidth]{../Figures/Robots/nov-2-\i.jpg}\hspace{-0.16cm}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.055\textwidth]{../Figures/Robots/nov-3-\i.jpg}\hspace{-0.16cm}
}\\
\foreach \i in {1,2,3,4,5,6,7,8}{
\includegraphics[width=0.055\textwidth]{../Figures/Robots/nov-4-\i.jpg}\hspace{-0.16cm}
}\\
