...
{
\usebackgroundtemplate{\putat{22}{-80}{\includegraphics[width=0.2\paperwidth]{../Figures/Misc/ACT_logo.eps}}}
\begin{frame}[plain]
\vspace{1cm}
\begin{center}
...
Dario \textsc{Izzo}, {\scriptsize ESA-ESTEC}\\
Daniel \textsc{Hennes}, {\scriptsize ESA-ESTEC}
\end{flushright}
\end{minipage}\\[0.5cm]
\end{center}
\end{frame}
...
\begin{frame}{Neuroevolution}
\begin{block}{Traditional neuro-evolutionary methods}
\centering
