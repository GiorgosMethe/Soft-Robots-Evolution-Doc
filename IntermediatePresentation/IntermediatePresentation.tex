...
\end{itemize}
\end{block}
\putat{75}{-110}{\includegraphics[scale=0.12]{figures/voxcad.png}}
\begin{itemize}
\item Lattice
\item Voxels
\item Structure
...
\begin{itemize}
\item Fitness traditionally measures how good an individual is (Objective function).
\item Objective function can prevent evolution reaching each target.
...
\end{itemize}
\item If distance less than a threshold store the individual.
\end{itemize}
\end{frame}
...
\begin{frame}{Primilinary results}
\begin{center}
\putat{-190}{-130}{\includegraphics[scale=0.29]{figures/noveltyFitnessDirect.eps}}
\end{center}
\end{frame}
