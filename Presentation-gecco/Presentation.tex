...
\putat{22}{-70}{\includegraphics[width=0.2\paperwidth]{../Figures/Misc/1b_CWI_LogoPMS193.png}}}
...
{
\usebackgroundtemplate{\putat{0}{-275}{\includegraphics[width=\paperwidth,height=\paperheight]{../Figures/Misc/rosetta-philae_touchdown.jpg}}}
...
\item \textcolor{white}{No restrictions in locomotion strategy}
\end{itemize}
\vspace{0.2cm}
...
\item Increased performance on different settings
\item Performance is not much affected by the behavior metric
\item Fitness elitism further improves performance
